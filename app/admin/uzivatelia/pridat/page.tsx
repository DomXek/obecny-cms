  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-gray-950 text-white">
      <div className="h-14 bg-gray-900 border-b border-gray-800 flex items-center px-6 shrink-0">
        ...
        <span className="text-sm font-semibold">Pridať užívateľa</span>
      </div>
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center">
          <div className="w-16 h-16 bg-gray-800 rounded-2xl flex items-center justify-center mx-auto mb-4">
            <UserPlus size={28} className="text-gray-600" />
          </div>
          <p className="text-gray-500 text-sm">Pridať užívateľa — čoskoro</p>
        </div>
      </div>
    </div>
  )
