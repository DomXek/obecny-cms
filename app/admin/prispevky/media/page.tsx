  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-gray-950 text-white">
      <div className="h-14 bg-gray-900 border-b border-gray-800 flex items-center px-6 shrink-0">
        <Image size={16} className="text-gray-400 mr-2" />
        <span className="text-sm font-semibold">Media / Galéria</span>
      </div>
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500 text-sm">Media / Galéria — čoskoro</p>
        </div>
      </div>
    </div>
  )
